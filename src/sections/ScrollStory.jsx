  ...
  return (
    ...
    >
      ...
      <svg width={size} height={size} viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute inset-0">
        ...
        {/* Center content - mathematically balanced vertically between the stars */}
        <text x="100" y={centerSubtext ? 87 : 96} textAnchor="middle" style={{ fontSize: "30px", fontFamily: "'Anton', sans-serif", letterSpacing: "2px" }} fill={`url(#grad-${textId})`}>{centerTextLine1}</text>
        <text x="100" y={centerSubtext ? 115 : 126} textAnchor="middle" style={{ fontSize: "26px", fontFamily: "'Anton', sans-serif", letterSpacing: "2px" }} fill={`url(#grad-${textId})`}>{centerTextLine2}</text>
        
        {centerSubtext && (
          <text x="100" y="135" textAnchor="middle" style={{ fontSize: "10px", fontFamily: "'Inter', sans-serif", fontWeight: "600", letterSpacing: "6px" }} fill="#F4EFE6" opacity="0.7">{centerSubtext}</text>
        )}
