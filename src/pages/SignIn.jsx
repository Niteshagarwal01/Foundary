  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.status === "complete") {
        ...
        setError("Additional verification required. Please use the standard Clerk UI or enable simple passwords.");
      }
    } catch (err) {
    ...
    <div className="min-h-screen bg-[#080808] flex relative overflow-hidden">
      ...
      <div className="hidden lg:flex w-1/2 relative flex-col justify-between p-16 border-r border-[#C9A355]/10 z-10">
        ...
        <div className="relative z-10 mb-20">
          ...
          >
            Access your curated typefaces, manage licenses, and discover new pairings.
          </motion.p>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-6 lg:p-16 relative z-10">
        ...
        >
          <div className="mb-10 text-center lg:text-left">
            <h2 className="font-display text-[#F4EFE6] text-4xl tracking-widest uppercase mb-3">Sign In</h2>
            <p className="font-serif italic text-[#A09890] text-lg">Welcome back. Enter your credentials to continue.</p>
          </div>
          ...
          <p className="mt-8 text-center text-[#6B6560] font-sans text-sm">
            Don't have an account? <Link to="/sign-up" className="text-[#C9A355] hover:text-[#F0D48A] font-bold transition-colors">Sign up</Link>
          </p>
        </motion.div>
      </div>
    </div>
