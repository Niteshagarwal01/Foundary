...
export default function SignInPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] flex items-center justify-center relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between p-6 lg:p-16 relative z-10">
        ...
        {/* Right Form Section (Glassmorphism Card) */}
        <motion.div
